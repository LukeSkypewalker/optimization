...
import branch_n_bound_sorted_weight as branch_weight
import branch_n_bound_sorted_weight_relax as branch_weight_relax
from common import *
...
for f in (files[14], files[6], files[10], files[12]):
    ...
    # print branch_un
    branch_s = branch_weight.solve_it(get_data('./data/' + f))
    print branch_s
    branch_d = branch_weight_relax.solve_it(get_data('./data/' + f))
    print branch_d
